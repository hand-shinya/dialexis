...
2. **研究デスク** — 問い・主張・根拠・反証・未確認事項・判断を第一級の対象とする研究過程グラフ。ノードごとの来歴、固定の確度分類（確定/高蓋然/未確認/解釈仮説/思弁）、Markdown / JSON-LD への完全エクスポート。翻訳・受容史・出典を独立した研究台帳として保存でき、一つの台帳を複数プロジェクトで共有し、プロジェクトから複数台帳を参照できます。
